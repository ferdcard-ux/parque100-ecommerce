...
export function AdminInventoryPage({ products, onDelete }: AdminInventoryPageProps) {
    ...
    <div className="min-h-screen bg-[#F5F5F5] flex">
      ...
      <main className="flex-1 min-w-0 overflow-auto">
        ...
        <div className="p-6">
          ...
          />
          <ProductTable products={products} onDelete={onDelete} onAddClick={() => setShowAddModal(true)} />
        </div>
      </main>
